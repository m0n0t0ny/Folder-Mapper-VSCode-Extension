...
# ╔════════════════════════════════════════════════════════════════════════════╗
# ║                    FOLDER MAPPER IGNORE CONFIGURATION GUIDE                ║
# ╚════════════════════════════════════════════════════════════════════════════╝
...
export const springBootIgnoreContent = `# java-spring-boot.foldermapperignore: Configuration file for excluding Java Spring Boot files and directories

# ╔════════════════════════════════════════════════════════════════════════════╗
# ║                 SPRING BOOT IGNORE CONFIGURATION GUIDE                      ║
# ╚════════════════════════════════════════════════════════════════════════════╝
...
export const angularIgnoreContent = `# angular.foldermapperignore: Configuration file for excluding Angular files and directories

# ╔════════════════════════════════════════════════════════════════════════════╗
# ║                    ANGULAR IGNORE CONFIGURATION GUIDE                       ║
# ╚════════════════════════════════════════════════════════════════════════════╝
